...
import cn.edu.hitsz.compiler.Main;
...
public class SymbolTable {
    public List<SymbolTableEntry> symbolTableList = new ArrayList<>();
    ...
    public boolean add(String text) {
        if(!has(text))
            return symbolTableList.add(new SymbolTableEntry(text));
        else
            throw new NotImplementedException();
    }
    ...
    public boolean has(String text) {
        ...
        return symbolTableList.contains(symbolTableEntry);
    }
    ...
    private Map<String, SymbolTableEntry> getAllEntries() {
        Map<String, SymbolTableEntry> allEntries = new HashMap<>();
        for(var symbolTableEntry : symbolTableList){
            String s = symbolTableEntry.getText();
            allEntries.put(s,symbolTableEntry);
        }
        return allEntries;
        //throw new NotImplementedException();
    }
